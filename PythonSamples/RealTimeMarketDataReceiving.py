# The sample demonstrates real-time data receiving
...
class RealTimeMarketDataReceiving(CELEnvironment.CELSinkBase):
    def __init__(self):
...
CELEnvironment.StartSample(RealTimeMarketDataReceiving)
